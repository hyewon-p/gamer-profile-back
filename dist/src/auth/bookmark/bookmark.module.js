...
BookmarkModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [...bookmark_repository_1.bookmarkRepository, bookmark_service_1.bookmarkService],
        controllers: [bookmark_controller_1.BookmarkController],
        exports: [...bookmark_repository_1.bookmarkRepository, bookmark_service_1.bookmarkService],
    })
], BookmarkModule);
